<nav class="main-menu__solution">
	<?php
	if( is_page_template( 'template-solucao.php' ) ):
		$activeBlog = "main-btn__solution--orange--active";
	endif;
	?>
    <a href="<?= esc_url(home_url('nossas-solucoes')) ?>" class="btn main-btn main-btn__solution main-btn__solution--orange <?= $activeBlog ?>">
        Todos
    </a>
	<?php
