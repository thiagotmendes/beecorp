...
wow=new WOW({boxClass:"wow",animateClass:"animated",offset:0,mobile:!0,live:!0}),wow.init();var mainNav=document.querySelector(".main-nav");window.addEventListener("scroll",function(e){50<window.scrollY?(mainNav.classList.add("fixed-top"),mainNav.classList.add("scroll-nav-top")):(mainNav.classList.remove("fixed-top"),mainNav.classList.remove("scroll-nav-top"))});var openMenuResponsive=document.querySelector(".main-responsive__btn-menu"),openBodyResponsive=document.querySelector(".main-responsive__body"),bodySite=document.body;openBodyResponsive&&openMenuResponsive.addEventListener("click",function(e){this.classList.toggle("main-responsive__btn-menu--open"),openBodyResponsive.classList.toggle("main-responsive__body--open"),bodySite.classList.toggle("scroll-block"),e.preventDefault()});var closeMenuResponsiveBody=document.querySelector(".main-responsive__close-menu");closeMenuResponsiveBody&&closeMenuResponsiveBody.addEventListener("click",function(e){openMenuResponsive.classList.toggle("main-responsive__btn-menu--open"),openBodyResponsive.classList.remove("main-responsive__body--open"),e.preventDefault()});var SPMaskBehavior=function(e){return 11===e.replace(/\D/g,"").length?"(00) 00000-0000":"(00) 0000-00009"},spOptions={onKeyPress:function(e,n,t,o){t.mask(SPMaskBehavior.apply({},arguments),o)}};function settingSlider(e){var n;return n=1<e?{loop:!0,autoplay:{delay:6500,disableOnInteraction:!0}}:n}$(".telefone").mask(SPMaskBehavior,spOptions),$(".dinheiro").mask("000.000.000.000.000,00",{reverse:!0});let qtdSliders=document.querySelectorAll(".main-banner__principal "),bannerSlider=new Swiper(".banner-slider",settingSlider(qtdSliders.length));var swiperForm=new Swiper(".slider-clientes",{slidesPerView:5,spaceBetween:30,loop:!0,autoplay:{delay:6500,disableOnInteraction:!0},breakpoints:{640:{slidesPerView:1,spaceBetween:20},768:{slidesPerView:4,spaceBetween:40},1024:{slidesPerView:5,spaceBetween:50}}}),swiperCases=new Swiper(".projetos-slider",{slidesPerView:3,loop:!0,centeredSlides:!0,autoplay:{delay:6500,disableOnInteraction:!0},breakpoints:{640:{slidesPerView:1,spaceBetween:20},768:{slidesPerView:4,spaceBetween:40},1024:{slidesPerView:5,spaceBetween:50}},navigation:{nextEl:".btn-slider__next",prevEl:".btn-slider__prev"}}),swiperDepoimentos=new Swiper(".slider-depoimentos",{slidesPerView:1,spaceBetween:30,loop:!0,autoplay:{delay:6500,disableOnInteraction:!1},pagination:{el:".swiper-pagination",clickable:!0}});let colAnimate=document.querySelectorAll(".main-animation__col");function addEfect(n){let t=setInterval(function(){if("visible"==n.style.visibility){let e=n.getElementsByClassName("main-animation__col__col-title")[0];e.classList.add("main-animation__col__col-title--active"),clearInterval(t)}},1e3)}colAnimate.forEach(function(e,n){setTimeout(function(){addEfect(e)},3e3)});let modalOpen=document.querySelectorAll(".main-modal"),btnModalOpen=document.querySelectorAll(".open-modal"),btnCloseModal=document.querySelectorAll(".main-modal__close");function openModal(o){return modalOpen.forEach(function(e,n){var t=e.dataset.modalname;if(o===t)return e.classList.toggle("main-modal--active")}),null}btnModalOpen.forEach(function(e,n){e.addEventListener("click",function(e){openModal(this.dataset.modal),e.preventDefault()})}),btnCloseModal.forEach(function(e,n){e.addEventListener("click",function(e){openModal(this.dataset.modalclose),e.preventDefault()})}),document.querySelector(".global-search").addEventListener("click",function(e){document.querySelector(".dropdown-search").classList.toggle("fadeInDown")});let btnSuspenso=document.querySelector(".btn-suspenso"),boxBtnSuspenso=document.querySelector(".btn-suspenso__box");btnSuspenso.addEventListener("click",function(e){btnSuspenso.classList.toggle("btn-suspenso--active"),boxBtnSuspenso.classList.toggle("btn-suspenso__box--active"),e.preventDefault()});let btnLoadMore=document.querySelector(".main-btn__load");function loadMore(e,n,t,o){$(".load_ring").addClass("load_ring__active");let s,a;a=t?(s="&post_category="+t,"&post_taxonomy="+o):s="",$.ajax({type:"get",url:disparaForm.ajax_url,data:"&action=loadMore&page="+e+"&post_type="+n+s+a,dataType:"html",success:function(e){return setTimeout(function(){$(".load_ring").removeClass("load_ring__active"),$(".load_more").append(e)},3e3),!1}})}btnLoadMore&&btnLoadMore.addEventListener("click",function(e){loadMore(this.dataset.page,this.dataset.post,this.dataset.category,this.dataset.taxonomy),this.dataset.page++,e.preventDefault()});